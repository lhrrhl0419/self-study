...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        W2, W3 = np.random.randn(num_filters * (input_dim[1] // 2) * (input_dim[2] // 2), hidden_dim) * weight_scale, np.random.randn(hidden_dim, num_classes) * weight_scale
    ...
    def loss(self, X, y=None):
        ...
        dy2, dW3, db3 = affine_backward(dscores, cache3)
        dy1, dW2, db2 = affine_relu_backward(dy2, cache2)
        _, dW1, db1 = conv_relu_pool_backward(dy1, cache1)
        dW3 += self.reg * W3
        dW2 += self.reg * W2
        dW1 += self.reg * W1
